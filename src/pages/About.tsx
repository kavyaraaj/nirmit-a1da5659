      ...
      <div className="pt-24 sm:pt-32 pb-16 sm:pb-20 px-4">
        <div className="container mx-auto max-w-6xl" ref={contentRef}>
          ...
          <div className="text-center mb-12 sm:mb-20 fade-in-section">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-foreground mb-4 sm:mb-6">About Us</h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 items-center mb-12 sm:mb-20">
            <div className="space-y-4 sm:space-y-6 fade-in-section">
            ...
            <div className="fade-in-section">
              <div className="glass rounded-2xl sm:rounded-3xl p-5 sm:p-8 shadow-glass">
                <div className="aspect-[4/3] rounded-xl sm:rounded-2xl bg-gradient-to-br from-accent/20 to-primary/20 flex items-center justify-center">
                  <div className="text-center space-y-3 sm:space-y-4 px-4">
                    <img src={logo} alt="Nirmit Labs" className="w-32 sm:w-48 h-auto mx-auto" />
                    <p className="text-base sm:text-lg font-semibold text-foreground">Innovation. Precision. Excellence.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Values */}
          <div className="space-y-8 sm:space-y-12 fade-in-section">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground text-center">Our Core Values</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              {[
                ...
                <TiltedCard key={value.title}>
                  <div 
                    className="glass glass-hover rounded-xl sm:rounded-2xl p-5 sm:p-8 text-center space-y-3 sm:space-y-4 h-full"
          ...
          {/* Stats */}
          <div className="mt-12 sm:mt-20 glass rounded-2xl sm:rounded-3xl p-6 sm:p-12 fade-in-section">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-8">
              {[
                ...
                <div key={stat.label} className="text-center space-y-1 sm:space-y-2">
                  <div className="text-2xl sm:text-4xl md:text-5xl font-bold gradient-text">{stat.number}</div>
